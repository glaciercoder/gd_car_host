...
/* 从LSB开始连续设置掩码， 如：count=2，结果是0x00000003U*/
#define MASK_BITS_FROM_LSB(count) (~((0xffffffffU >> (count)) << (count)))

#define COUNT_OF(x) (sizeof(x)/sizeof(x[0]))
#define _BIT_(x) (1U<<(x))

// #define DEBUG_WDG_OFF  // 关看门狗
//  #define DEBUG_REALTIME // 调试实时性
#if defined(DEBUG_WDG_OFF)
#define NONE_BOOTLD_MODE // 无BootLoader模式
#endif
...
#define USE_GPRMC_FROM_UART  // 从串口获取GPRMC
