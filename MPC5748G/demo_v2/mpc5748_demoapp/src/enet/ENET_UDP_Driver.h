...
* Global Variables
**********************************************************************************************/
extern volatile uint8_t ENET_ARP_RequestFlag;
extern volatile uint8_t ENET_ICMP_RequestFlag;
...
uint8_t* Get_Local_ARP_Packet(void);
...
unsigned short ENET_Calc_Checksum(uint8_t* data,uint16_t len);
