...
/*========================================================================*/
void dummy 						  (void);
extern void flexCan0ReceiveInterruptHandle_isr(void);
extern void flexCan1ReceiveInterruptHandle_isr(void);
extern void flexCan2ReceiveInterruptHandle_isr(void);
extern void flexCan3ReceiveInterruptHandle_isr(void);
extern void flexCan4ReceiveInterruptHandle_isr(void);
extern void flexCan5ReceiveInterruptHandle_isr(void);
extern void flexCan6ReceiveInterruptHandle_isr(void);
extern void flexCan7ReceiveInterruptHandle_isr(void);
extern void PIT0_isr(void);
extern void PIT1_isr(void);
extern void PIT2_isr(void);
extern void ENET_Rx_Handle_isr(void);
extern void uartRxInterrupt_isr(void);
extern void uart1RxInterrupt_isr(void);
extern void uart3RxInterrupt_isr(void);
extern void uart6RxInterrupt_isr(void);
extern void uart6TxInterrupt_isr(void);
extern void flexCan1MB_4_7_isr(void);/* Vector # 581 FlexCAN1_3 FlexCAN1_BUF_04_07 */
extern void flexCan1MB_8_11_isr(void);/* Vector # 582 FlexCAN1_4 FlexCAN1_BUF_08_11 */
extern void flexCan1MB_12_15_isr(void);/* Vector # 583 FlexCAN1_5 FlexCAN1_BUF_12_15 */
extern void flexCan1MB_16_31_isr(void);/* Vector # 584 FlexCAN1_6 FlexCAN1_BUF_16_31 */

extern void flexCan2MB_4_7_isr(void);
extern void flexCan2MB_8_11_isr(void);
extern void flexCan0MB_4_7_isr(void);
/*========================================================================*/
/*	GLOBAL VARIABLES						                              */
/*========================================================================*/
...
(uint32_t) &ENET_Rx_Handle_isr, /* Vector # 211 ENET Interrupt Group1 ENET_1 */
...
(uint32_t) &uartRxInterrupt_isr, /* Vector # 376 LinFLEX0_0 LinFlex_0_RXI */
(uint32_t) &dummy, /* Vector # 377 LinFlex0_1 LinFlex_0_TXI */
(uint32_t) &dummy, /* Vector # 378 LinFlex0_2 LinFlex_0_ERR */
(uint32_t) &uart1RxInterrupt_isr, /* Vector # 379 LinFlex1_0 LinFlex_1_RXI */
...
(uint32_t) &uart3RxInterrupt_isr, /* Vector # 385 LinFlex3_0 LinFlex_3_RXI */
...
(uint32_t) &uart6RxInterrupt_isr, /* Vector # 394 LinFlex6_0 LinFlex_6_RXI */
(uint32_t) &uart6TxInterrupt_isr, /* Vector # 395 LinFlex6_1 LinFlex_6_TXI */
...
(uint32_t) &flexCan1ReceiveInterruptHandle_isr, /* Vector # 580 FlexCAN1_2 FlexCAN1_BUF_00_03 */
(uint32_t) &flexCan1MB_4_7_isr, /* Vector # 581 FlexCAN1_3 FlexCAN1_BUF_04_07 */
(uint32_t) &flexCan1MB_8_11_isr, /* Vector # 582 FlexCAN1_4 FlexCAN1_BUF_08_11 */
(uint32_t) &flexCan1MB_12_15_isr, /* Vector # 583 FlexCAN1_5 FlexCAN1_BUF_12_15 */
(uint32_t) &flexCan1MB_16_31_isr, /* Vector # 584 FlexCAN1_6 FlexCAN1_BUF_16_31 */
...
(uint32_t) &flexCan2ReceiveInterruptHandle_isr, /* Vector # 592 FlexCAN2_2 FlexCAN2_BUF_00_03 */
(uint32_t) &flexCan2MB_4_7_isr, /* Vector # 593 FlexCAN2_3 FlexCAN2_BUF_04_07 */
(uint32_t) &flexCan2MB_8_11_isr, /* Vector # 594 FlexCAN2_4 FlexCAN2_BUF_08_11 */
...
(uint32_t) &flexCan3ReceiveInterruptHandle_isr, /* Vector # 604 FlexCAN3_2 FlexCAN3_BUF_00_03 */
